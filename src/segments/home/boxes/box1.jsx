...
export const Box1 = ({ isActive }) => {
  ...
  return (
    ...
    >
      ...
      ></div>
      <div className="h-full md:bg-[#1d1d1d] border-[1px] border-green-600 md:border-[0px] rounded-[15px] opacity-80 shadow-[0_0px_10px_5px_rgba(0,0,0,0.15)] z-0 flex items-center justify-center">
        <h2
