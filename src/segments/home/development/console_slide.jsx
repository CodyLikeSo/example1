  ...
  return (
    <div>
      <div className="flex h-screen justify-center items-center bg-transparent w-full overflow-hidden relative">
        <div
          className={`w-4/5 h-full sm:h-full md:h-4/5 lg:h-3/5 lg:w-3/5 rounded-[30px] md:shadow-[0_0px_40px_10px_rgba(0,0,0,0.5)] md:border border-green-600 p-[3%] relative md:bg-[#242424]`}
