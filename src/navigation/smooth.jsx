  ...
  return (
    <div className="flex h-screen relative overflow-hidden">
      ...
      <div className="flex justify-center items-center w-full overflow-hidden">
        ...
        {activeScreen === null && (
          <div className="absolute w-3/5 h-3/5 p-4 bg-[#242424] rounded-[30px] shadow-[0_0px_40px_10px_rgba(0,0,0,0.25)] text-[#D9D9D9] transition-all duration-700 ease-in-out opacity-100 transform scale-100">
